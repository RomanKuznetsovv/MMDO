namespace Mmdo_coursework
{
    partial class SystemSolutionForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            cmbMethod = new ReaLTaiizor.Controls.PoisonComboBox();
            ...
            back_Button.Location = new Point(453, 90);
            ...
            back_Button.TextButton = "Додому Волтер";
            ...
            rbMin.AutoSize = true;
            rbMin.Depth = 0;
            rbMin.Location = new Point(195, 108);
            ...
            rbMax.AutoSize = true;
            rbMax.Depth = 0;
            rbMax.Location = new Point(278, 108);
            ...
            materialLabel4.Location = new Point(7, 159);
            materialLabel4.MouseState = ReaLTaiizor.Helper.MaterialDrawHelper.MaterialMouseState.HOVER;
            materialLabel4.Name = "materialLabel4";
            materialLabel4.Size = new Size(190, 24);
            materialLabel4.TabIndex = 26;
            materialLabel4.Text = "Метод розв'язання :";
            // 
            // webView21
            // 
            ...
            webView21.Location = new Point(7, 205);
            ...
            btnSolve.Location = new Point(453, 32);
            ...
            cmbMethod.ItemHeight = 24;
            cmbMethod.Items.AddRange(new object[] { "Симплекс-метод", "Метод штучного базису" });
            cmbMethod.Location = new Point(218, 157);
            cmbMethod.Name = "cmbMethod";
            cmbMethod.Size = new Size(151, 30);
            cmbMethod.TabIndex = 29;
            cmbMethod.UseSelectable = true;
            // 
            // SystemSolutionForm
            // 
        ...
        private ReaLTaiizor.Controls.PoisonComboBox cmbMethod;
    }
}